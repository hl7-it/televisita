...
* entry[1].resource = PatientTelevisitaExample

* entry[2].fullUrl = "http://example/PractitionerRole/e446e848-2bd4-423a-b2f8-5d25687e2f42"
* entry[2].resource = PractitionerRoleTelevisitaExample
...
* entry[4].resource = PractitionerTelevisitaExample

* entry[5].fullUrl = "http://example/Encounter/a2aaf911-51e7-4e38-a7ca-2817c0fcc6d2"
* entry[5].resource = EncounterTelevisitaExample
...
* entry[21].resource = AppointmentTelevisitaExample

* entry[22].fullUrl = "http://example/Procedure/b81d2c4e-5a9f-4c97-90fb-2a3b726b123f"
* entry[22].resource = ProcedureTelevisitaExample
...
* participant[0].individual = Reference(PractitionerTelevisitaExample)
//* reasonReference[0] = Reference(ProcedureTelevisitaExample)

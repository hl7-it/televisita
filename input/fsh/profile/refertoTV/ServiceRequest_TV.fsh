Alias: $ServiceRequest = https://agenas.gov.it/fhir/StructureDefinition/ServiceRequestTV
...
* code.coding contains
    codiceNomenclatoreTariffario 0..1
...
// * code.coding[codiceCatalogoRegionalePrestazione] from VsCatalogoNazionalePrestazioni (preferred)
